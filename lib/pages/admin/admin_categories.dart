...
class _AdminCategoriesState extends State<AdminCategories> {
        ...
        children: [
          ...
          DotsIndicator(
            ...
            decorator: DotsDecorator(
              activeColor: const Color(0xff1C6EAB),
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                      "Miqdori: ${orderList[index]['amount']}kg",
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      "Zakaz kuni: ${orderList[index]['orderedDate']}".substring(0,28),
                                      style: const TextStyle(fontSize: 15),
                                    ),
                                  )
                                ],
  ...
  Widget _buildPageItem(int index) {
    final List<Category> categories = [
      Category(
          id: '1', title: 'Klient kiritish', onPressed: const CreateClient()),
      Category(
          id: '2', title: 'Zakaz qilish', onPressed:  CreateOrder( username: token,)),
